...
def call_mat_stim_trial_loader(*args, **kwargs):
    ...
    warnings.warn(
        "Called call_mat_stim_trial_loader from utils.deepsqueak. Switch import to utils.callback!"
    )
...
def multi_index_from_dict(*args, **kwargs):
    from .file import multi_index_from_dict
    import warnings

    warnings.warn(
        "Called multi_index_from_dict from utils.deepsqueak. Switch import to utils.files!"
    )
